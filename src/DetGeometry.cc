...
*/
    ...
    G4VisAttributes* GR = new G4VisAttributes (G4Colour::Red());
    ...
    new G4PVPlacement(0, G4ThreeVector(0* cm, 0 *cm, 0*cm), one, "sphere", logicWorld, false, 0);
   // new G4PVPlacement(0, G4ThreeVector(0* cm, 10 *cm, 0*cm), two, "box", logicWorld, false, 0);
    //new G4PVPlacement(0, G4ThreeVector(0* cm, 0 *cm, 0*cm), three, "tube", logicWorld, false, 0);
